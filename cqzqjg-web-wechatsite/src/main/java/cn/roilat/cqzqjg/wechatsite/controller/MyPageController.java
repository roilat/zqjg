...
public class MyPageController {
    ...
    /*
     * @GetMapping(value = "/page/{username}") public HttpResult login(@PathVariable
     * String username) throws IOException { BizMemberUserRespVo user =
     * bizMemberUserService.findByNameMyPage(username); if (null == user) { return
     * HttpResult.error("用户不存在"); } return HttpResult.ok("查询成功", user); }
     */
    ...
    public HttpResult companyDetail(@PathVariable Long id) throws IOException {
        ...
        BizMemberCompanyResp bizMemberCompanyResp = bizMemberCompanyService.findByIdResp(Long.valueOf(bizMemberUser.getCompanyId()));
