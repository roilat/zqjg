package cn.roilat.cqzqjg.common.aspect;
...
import cn.roilat.cqzqjg.common.util.HttpUtils;
import cn.roilat.cqzqjg.common.util.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("execution(* cn.roilat.cqzqjg.*.service.*.*(..))")
